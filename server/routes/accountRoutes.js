...
router.patch('/:accountNumber', validate, checkEditAccount, validateResult, verifyToken, verifyAdmin, accountController.editAccount);
router.delete('/:accountNumber', validate, checkDeleteAccount, validateResult, verifyToken, verifyAdmin, accountController.deleteAccount);
router.get('/:accountNumber/transactions', validate, checkGetAllTrans, validateResult, verifyToken, verifyAccountOwner, transactionController.getTransactions);
router.get('/:email/accounts', checkAllUserAccounts, validateResult, verifyToken, accountController.getAllUserAccounts);
router.get('/:accountNumber', validate, checkGetSingleAccount, validateResult, verifyToken, accountController.getSingleAccount);
